...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ortho_5x14(
    /* Base
      ...
      * `-------------------------------------------------------------------------------------------------' 
      */
    KC__MUTE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_HOME, KC_END,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV,
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_SLASH, KC_BSLS, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_DEL,
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LBRC, KC_RBRC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_MINS, KC_EQL,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_RSPC,
    KC_LCTL, KC_LGUI, KC_CAPS, KC_LALT, MO(2),   KC_BSPC, KC_BSPC, KC_SPC,  KC_SPC,  KC_ENT,  TG(1),   KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [1] = LAYOUT_ortho_5x14( 
    ...
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS, KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS,
